...
import { Box, Drawer, Divider, ListItemButton, ListItemIcon } from '@mui/material';
import { Home as HomeIcon, Info as InfoIcon, CommentRounded as CommentRoundedIcon, PhoneRounded as PhoneRoundedIcon, ShoppingCartRounded as ShoppingCartRoundedIcon } from '@mui/icons-material';
    ...
    <nav>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div className="navbar-links-container" style={{ display: "flex", justifyContent: "flex-end" }}>
          ...
          <FontAwesomeIcon icon={faHeart} style={{ color: 'Red', marginRight: "30px", marginLeft: "20px" }} onClick={handleWishlistClick} />
        </div>  
      </div>
      <Popover
        id={id}
